...
from adminapp.views import UsersListView, UserCreateView, ProductCategoryCreateView, ProductCategoryListView
from adminapp.views import ProductCategoryUpdateView
app_name = 'adminapp' # обязательно с namespace

urlpatterns = [
    # path('users/create/', adminapp.user_create, name='user_create'), - на функциях если
